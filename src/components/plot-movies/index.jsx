...
import dataRaw from "../../data/movie-sales.json";

export function PlotMosaicMovies({
  width = 1000,
  height = 600,
  margin = 30,
}) {
  ...
  const Component = `PlotMosaicMovies`;
  ...
  useEffect(() => {
    ...
    const plot = Plot.plot({
      ...
      // texts
      title: "Movie Sales",
      subtitle: "Top 100 Most Sold Movies Grouped by Genre",
      //caption: htl.html`.`,
