...
import dataRaw from "../../data/kickstarter-invest.json";

export function PlotMosaicKickstarter({
  width = 1000,
  height = 600,
  margin = 30,
}) {
  ...
  const Component = `PlotMosaicKickstarter`;
...
PlotMosaicKickstarter.propTypes = {
